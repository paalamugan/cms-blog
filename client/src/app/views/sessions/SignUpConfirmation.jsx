        ...
        <Paper className={`bg-white ${classes.flexCenter} ${classes.inner}`}>
          <div className="text-left mb-4">
            ...
            <p className={classes.paragraph}>
              Thanks for Signing Up. We've sent you an verify email to{" "}
            ...
            <p>
              Please find the email and click the confirmation link to activate
              your account.
            </p>
            <Divider />
            <p className="text-muted">
              If you do not receive an email in 5 minutes, please check your
              spam folder or email us at <em>contact@paalamugan.com</em>
            </p>
          </div>
          <Link to="/login">
            <Button
