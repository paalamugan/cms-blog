...
import BlogVerticalNavExpansionPanel from "./BlogVerticalNavExpansionPanel";
...
const BlogVerticalNav = props => {
  ...
  const renderLevels = data => {
    return data.map((item, index) => {
      if (item.children) {
        return (
          <BlogVerticalNavExpansionPanel item={item} key={index}>
            {renderLevels(item.children)}
          </BlogVerticalNavExpansionPanel>
        );
...
export default withStyles(styles)(BlogVerticalNav);
